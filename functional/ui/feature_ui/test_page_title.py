...
# @scenario('PageTitle.feature', 'Check page title for XX page', example_converters=dict(xx_link=str, xx=str))
@scenario(feature_file_path+'PageTitle.feature', 'Check page title for XX page')
